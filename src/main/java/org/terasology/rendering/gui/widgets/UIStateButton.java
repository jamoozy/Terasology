...
/**
 * This class extends the UIButton and adds functionality to add states to a button. Each state will be assigned a label
 * and a action to execute as the button enters the state.
 * @author Marcel Lehwald <marcel.lehwald@googlemail.com>
 *
 * TODO integrate into {@link UIButton}
 * @deprecated
 */
public class UIStateButton extends UIButton {
    ...
    /**
     * Change state to next state ID in the state list. As the end is reached the next state will be the first state in
     * the list.
     */
    ...
    /**
     * Change state to previous state ID in the state list. As the beginning is reached the next state will be the last
     * state in the list.
     */
